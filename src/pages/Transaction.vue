        ...
        <div class="space-y-4">
          ...
          <div class="filter-section flex items-center gap-4">
            ...
            <div class="flex items-center">
              ...
              <input id="startDate" type="date" v-model="dateRange.start" class="border p-2 rounded" />
            </div>

            <!-- End Date Input -->
            <div class="flex items-center">
              <label for="endDate" class="mr-2 text-sm">End Date:</label>
              <input id="endDate" type="date" v-model="dateRange.end" class="border p-2 rounded" />
            </div>
